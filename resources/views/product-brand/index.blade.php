        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                    {{ __('backend.productbrand.productbrands') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    @trashed
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('backend.productbrand.trashed_productbrands') }}</li>
                        <!--end::Item-->
                    @else
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('backend.productbrand.productbrands') }}</li>
                        <!--end::Item-->
                    @endtrashed
                </ul>
                <!--end::Breadcrumb-->
                        ...
                        <div class="card-toolbar">
                            @trashed
                                ...
                                <a href="{{ route('product-brand.index') }}"
                                    ...
                                    <!--end::Svg Icon-->
                                    {{ __('backend.productbrand.productbrands') }}
                                </a>
                                <!--end::Category list-->
                            @else
                                <!--begin::Add category-->
                                <a href="{{ route('product-brand.create') }}"
                                    ...
                                    <!--end::Svg Icon-->
                                    {{ __('backend.productbrand.create') }}
                                </a>
                                <!--end::Add category-->
                            @endtrashed
                        </div>
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class=" text-nowrap  sorting" tabindex="0"
                                            ...
                                            {{ __('backend.productbrand.productbrand') }}</th>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">
                                                {{ __('backend.productbrand.not_found') }}</td>
                                        </tr>
                                    @endforelse
