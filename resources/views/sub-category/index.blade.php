                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        @trashed
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('sub-category.index') }}" class="text-muted text-hover-primary">Sub
                                    Categories</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-nowarp text-center min-w-70px sorting_disabled" rowspan="1"
                                                colspan="1" aria-label="Actions" style="width: 96.2292px;">Actions
                                            </th>
                                        </tr>
                                        <!--end::Table row-->
                                    </thead>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @forelse ($subCategories as $key => $subCategory)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('sub-category.update-status', $subCategory->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <div
