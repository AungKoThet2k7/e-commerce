        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                    {{ __('backend.subcategory.subcategories') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    @trashed
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('backend.subcategory.trashed_subcategories') }}</li>
                        <!--end::Item-->
                    @else
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('backend.subcategory.subcategories') }}</li>
                        <!--end::Item-->
                    @endtrashed
                </ul>
                <!--end::Breadcrumb-->
                        ...
                        <div class="card-toolbar">
                            @trashed
                                ...
                                <a href="{{ route('sub-category.index') }}"
                                    ...
                                    <!--end::Svg Icon-->
                                    {{ __('backend.subcategory.subcategories') }}
                                </a>
                                <!--end::Category list-->
                            @else
                                <!--begin::Add category-->
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-nowarp text-center min-w-70px sorting_disabled" rowspan="1"
                                            colspan="1" aria-label="Actions">{{ __('backend.common.actions') }}
                                        </th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class=" flex flex-col gap-1 items-start justify-center ms-5">
                                                        ...
                                                        <div class="badge badge-light-primary">
                                                            <a
                                                                href="{{ route('category.edit', $subCategory->category_id) }}">{{ $subCategory->category?->name ?? '---' }}</a>
                                                        </div>
                                                        <!--end::badge-->
                                                    </div>
                                                </div>
