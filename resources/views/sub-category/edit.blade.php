    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{ __('backend.subcategory.edit') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('sub-category.index') }}"
                            class="text-muted text-hover-primary">{{ __('backend.subcategory.subcategories') }}</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">{{ __('backend.subcategory.edit') }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <form action="{{ route('sub-category.update', $subCategory->id) }}" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-title">
                                <h2>{{ __('backend.subcategory.image') }}</h2>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--end::Card header-->
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    ...
                                    data-bs-original-title="{{ __('backend.subcategory.change_image') }}">
                                    <!--begin::Icon-->
                                ...
                                <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    ...
                                    data-bs-original-title="{{ __('backend.subcategory.cancel_image') }}">
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">{{ __('backend.subcategory.image_description') }}</div>
                            @error('image')
                            ...
                            <div class="flex flex-col items-start mt-5">
                                <!--begin::Label-->
                                <label class="required form-label">{{ __('backend.subcategory.image_alt') }}</label>
                                <!--end::Label-->
                                <input value="{{ old('image_alt', $subCategory->image_alt) }}" type="text"
                                    name="image_alt" class="form-control w-full mb-2"
                                    placeholder="{{ __('backend.subcategory.image_alt') }}">
                                @error('image_alt')
                                    <p class=" text-red-500 text-sm mt-2">{{ $message }}</p>
                                @enderror
                                <!--end::Input-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select name="status" class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                                ...
                                <option value="1" @selected(old('status', $subCategory->status) == 1)>{{ __('backend.common.active') }}
                                </option>
                                <option value="0" @selected(old('status', $subCategory->status) == 0)>{{ __('backend.common.inactive') }}
                                </option>
                            </select>
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">{{ __('backend.subcategory.status_description') }}</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{ __('backend.subcategory.create') }}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <span class="indicator-label">{{ __('backend.subcategory.update_subcategory') }}</span>
                        </button>
                        <!--end::Button-->
                    </div>
                </div>
