...
<body id="kt_body" class="bg-body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            style="background-image: url({{ asset('template/media/illustrations/sketchy-1/14.png') }})">
            <!--begin::Content-->
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                <a href="../../demo1/dist/index.html" class="mb-12">
                    <img alt="Logo" src="{{ asset('template/media/logos/logo-1.svg') }}" class="h-40px" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    {{-- <!--begin::Form-->   remove (  novalidate="novalidate" id="kt_sign_in_form"  data-kt-redirect-url="/dashboard" ) --}}
                    <form action="{{ route('login') }}" method="POST" class="form w-100">
                        ...
                        <div class="flex gap-3 mb-10">
                            <!--begin::Input-->
                            <input id="remember" class="check-input form-check-input" type="checkbox" name="remember" />
                            <!--end::Input-->
                            <!--begin::Label-->
                            <label for="remember" class="form-label fs-6 fw-bolder text-dark">Remember me</label>
                            <!--end::Label-->
                            @error('remember')
                                <p class=" text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
    ...
    <script src="{{ asset('template/js/custom/authentication/sign-in/general.js') }}"></script>
