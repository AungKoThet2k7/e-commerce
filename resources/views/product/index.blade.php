...
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="ms-3 m-0">
                <!--begin::Menu toggle-->
                <a href="#" class="group btn btn-flex btn-light btn-active-primary btn-text-primary fw-bolder" data-kt-menu-trigger="click"
                ...
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                    ...
                    <div class="flex flex-col gap-5 px-7 py-5">
                        ...
                        <div class="">
                            ...
                            <!--start::Brand-->
                            <div class="">
                                <select form="filterForm" name="filter_by_brand" class="form-select form-select-solid"
                                    data-kt-select2="true" data-placeholder="{{ __('backend.productbrand.productbrand') }}"
                        ...
                        <div class="">
                            ...
                            <!--start::Subcategory-->
                            <div class="">
                                <select form="filterForm" name="filter_by_subcategory" class="form-select form-select-solid"
                                    data-kt-select2="true" data-placeholder="{{ __('backend.subcategory.subcategory') }}"
                        ...
                        <div class="">
                            ...
                            <!--start::category-->
                            <div class="">
                                <select form="filterForm" name="filter_by_category" class="form-select form-select-solid"
                                    data-kt-select2="true" data-placeholder="{{ __('backend.category.category') }}"
                                    data-allow-clear="true" data-select2-id="select2-data-7-l7k2" tabindex="-1"
                                    aria-hidden="true">
                                    <option data-select2-id="select2-data-9-3eq9"></option>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="flex gap-3">
                        ...
                        @trashed
                            <!--begin::Product list-->
                            <a href="{{ route('product.index') }}" class="btn btn-primary flex items-center justify-center">
                        ...
                        @else
                            <!--begin::Add category-->
                            <a href="{{ route('product.create') }}" class="btn btn-primary flex items-center justify-center">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
