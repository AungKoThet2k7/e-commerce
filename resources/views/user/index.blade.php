                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid select2-hidden-accessible"
                                        ...
                                        data-dropdown-parent="#kt_menu_624475ed0ca19" data-allow-clear="true"
                                        data-select2-id="select2-data-7-pw6j" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="select2-data-9-rj4l"></option>
                                        <option value="1">Approved</option>
                                        <option value="2">Pending</option>
                                        <option value="2">In Process</option>
                                        <option value="2">Rejected</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5"
                                        dir="ltr" data-select2-id="select2-data-8-xadg" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-s2j4-container"
                                                aria-controls="select2-s2j4-container"><span
                                                    class="select2-selection__rendered" id="select2-s2j4-container"
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--begin::Add user-->
                            <button type="button" class="btn btn-primary flex" data-bs-toggle="modal"
                                        ...
                                        <form id="kt_modal_export_users_form"
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <select name="role" data-control="select2"
                                                    ...
                                                    data-select2-id="select2-data-16-ygvh" tabindex="-1"
                                                    aria-hidden="true">
                                                    <option data-select2-id="select2-data-18-j0am"></option>
                                                    ...
                                                    dir="ltr" data-select2-id="select2-data-17-7syg"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-role-j2-container"
                                                            aria-controls="select2-role-j2-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-role-j2-container" role="textbox"
                                            ...
                                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                                ...
                                                <select name="format" data-control="select2"
                                                    ...
                                                    class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                                    data-select2-id="select2-data-19-2dfs" tabindex="-1"
                                                    aria-hidden="true">
                                                    <option data-select2-id="select2-data-21-dcev"></option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-20-a4vj"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-format-2f-container"
                                                            aria-controls="select2-format-2f-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-format-2f-container" role="textbox"
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-26T10:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-07-25T18:05:00+06:30">25 Jul 2022, 6:05 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                    ...
                                    <tr class="even">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-27T10:14:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-02-21T10:30:00+06:30">21 Feb 2022, 10:30 am</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-24T10:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-06-24T14:40:00+06:30">24 Jun 2022, 2:40 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="even">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-27T05:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-03-10T17:30:00+06:30">10 Mar 2022, 5:30 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-25T10:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-10-25T11:30:00+06:30">25 Oct 2022, 11:30 am</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="even">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-22T10:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-04-15T21:23:00+06:30">15 Apr 2022, 9:23 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2025-11-06T10:34:50+06:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-05-05T17:30:00+06:30">05 May 2022, 5:30 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="even">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-07-25T11:30:00+06:30">25 Jul 2022, 11:30 am</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-03-10T11:05:00+06:30">10 Mar 2022, 11:05 am</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                                    ...
                                    <tr class="even">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-06-24T20:43:00+06:30">24 Jun 2022, 8:43 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
